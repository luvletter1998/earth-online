module.exports = [
  ...
  { category:'社交', title:'谁请客', description:'和朋友吃饭成功让朋友买单', icon:'🍽️', points:25, rarity:'稀有', unlock_condition:'朋友请客一次' },
  ...
  { category:'奇葩', title:'反向减肥', description:'办了健身卡后一个月内体重增加', icon:'🍔', points:5, rarity:'普通', unlock_condition:'办卡后体重上升' },
  { category:'奇葩', title:'地铁占座王', description:'高峰期抢到座位并坐过站', icon:'🚇', points:15, rarity:'稀有', unlock_condition:'高峰期抢座+坐过站' },
  { category:'奇葩', title:'反诈先锋', description:'接到诈骗电话后聊了超过10分钟', icon:'📞', points:20, rarity:'史诗', unlock_condition:'接诈骗电话>10min' },
  { category:'奇葩', title:'插队反杀', description:'被人插队后成功让对方出列', icon:'🗡️', points:25, rarity:'稀有', unlock_condition:'反插队成功' },
  { category:'奇葩', title:'点赞机器人', description:'给所有好友的朋友圈逐条点赞', icon:'🤖', points:30, rarity:'史诗', unlock_condition:'全好友逐条点赞' },
];
